      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8">
        ...
        <div className="grid grid-cols-3 gap-4">
          <button
            ...
            className="flex items-center justify-center gap-2 border border-gray-300 py-3 rounded-lg hover:bg-gray-50 transition duration-200"
          >
          ...
          <button
            type="button"
            onClick={() => apiClient.facebookLogin()}
            className="flex items-center justify-center gap-2 border border-gray-300 py-3 rounded-lg hover:bg-gray-50 transition duration-200"
          >
